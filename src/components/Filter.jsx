...
const Filter = () => {
  ...
  return (
    <div className="ml-2 my-5 p-2 border-none max-h-auto w-56 sticky top-44 z-30 bg-[#eec6c6] font-sans">
      <p className="p-2 text-xl font-bold text-rose-900">Filters</p>
      ...
      <div className="text-sm">
        ...
        <div className="p-2">
          ...
          <input
            type="range"
            value={priceRange}
            onChange={(e) => dispatch(FILTER_BY_PRICE_RANGE(e.target.value))}
            min="50"
            step="50"
            max="2000"
            className="w-full"
